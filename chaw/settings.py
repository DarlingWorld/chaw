...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'techbro.content_processor.cartcount',
            ],
        },
    },
]
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'sunset4darlington@gmail.com'
EMAIL_HOST_PASSWORD = 'lgpptbznwsdshfxh'
EMAIL_USE_TLS = True
#email settings done
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome to the Refill",
